            ...
            try {
                if (campoNota1.getText().trim().isEmpty() ||
                    ...
                    JOptionPane.showMessageDialog(this, 
                        "Es obligatorio ingresar las cinco notas. Por favor, complete todos los campos.", 
                        "Error de ingreso", JOptionPane.WARNING_MESSAGE);
                    return;
                }
                ...
                JOptionPane.showMessageDialog(this, 
                    "Debe ingresar valores numéricos válidos en todas las notas.", 
